...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.hidde_to_hidden_weight = nn.Parameter(torch.Tensor(self.hidden_size,self.hidden_size))
        nn.init.xavier_uniform_(self.hidde_to_hidden_weight)

        self.hidden_to_hidden_bias = nn.Parameter(torch.Tensor(self.hidden_size))
    ...
    def embedding_lookup(self, w):
        ...
        ###     Flatten: https://pytorch.org/docs/stable/generated/torch.flatten.htmlx
        ### END YOUR CODE
    ...
    def forward(self, w):
        ...
        x = torch.matmul(x , self.hidde_to_hidden_weight) + self.hidden_to_hidden_bias

        #END NEW CODE
        h = self.dropout(F.relu(x))
